...
int main(int ac, char **av) {
  fr_t fr = fr_prepare();
  int mul =  fr_monitor(fr, map_offset("/home/victim/Desktop/gpg-1.4.13", MUL_OFFSET));
  int sqr = fr_monitor(fr, map_offset("/home/victim/Desktop/gpg-1.4.13", SQR_OFFSET));
  int mod = fr_monitor(fr, map_offset("/home/victim/Desktop/gpg-1.4.13", MOD_OFFSET));
